...
#include<string>
#include<vector>
#include "D:\OpenCV\opencv_contrib\opencv_contrib\modules\mcc\include\opencv2\mcc\linearize.hpp"
...
namespace cv {
	namespace ccm {
		...
		public:
			...
			public:
				  std::shared_ptr<ColorCorrectionModel> ccm_loss;
				  LossFunction(std::shared_ptr<ColorCorrectionModel> ccm) : ccm_loss(ccm) {};
			...
			void fitting(void) {
				...
				std::cout << " ccm0 " << reshapeccm << std::endl;
